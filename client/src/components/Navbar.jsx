    ...
    <nav className="bg-[#FDF8EE] text-black">
      <div className="max-w-[90rem] mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center">
          ...
          <button className="bg-[#4D2C5E] text-white px-6 py-2 rounded-full hover:bg-purple-600 ml-4">
            Sign in
          </button>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          ...
          <button className="bg-[#4D2C5E] text-white px-6 py-2 rounded-full hover:bg-purple-600 mt-2 w-full">
            Sign in
          </button>
        </div>
      )}
